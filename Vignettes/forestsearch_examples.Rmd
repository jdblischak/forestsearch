...
output: 
  html_document:
         code_folding: hide
vignette: >
  %\VignetteIndexEntry{Forestsearch Example}
...
# Key Parameters for GRF

**grf_depth: Maximum depth of policy trees (1-3)
- **dmin.grf**: Minimum difference in subgroup mean for GRF
- **frac.tau**: Fraction of maximum follow-up time for RMST horizon
- **n.min**: Minimum subgroup size requirement
- **vi.grf.min**: Minimum variable importance threshold for screening
...
load("~/Documents/GitHub/forestsearch/vignettes/results/gbsg_results_B=1000.RData")
...
sg_tab <- summary$table

sg_tab


tables <- format_subgroup_summary_tables(summary$subgroup_summary,1000)

tables$original_agreement              # Agreement table

tables$factor_presence        # Factor frequency table
...
tables$factor_presence_specific

tables$factor_overall

tables$consistency_dist
