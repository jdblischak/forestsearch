...
sim_config_null <- list(
  n_sims = 2000,          # More simulations for Type I error estimation
  n_sample = 700,         # Sample size per trial
  max_follow = 84,        # Maximum follow-up (months)
  seed_base = 8316951,
  muC_adj = log(1.5)
...
fs_params <- list(
  ...
  use_twostage = FALSE,      # Set TRUE for faster exploratory analysis
