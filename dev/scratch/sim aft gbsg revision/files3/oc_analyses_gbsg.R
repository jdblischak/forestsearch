...
#'   including both HR and AHR metrics
#'
#' @details
#' ## Analysis Methods
#'
...
#' ## Output Metrics
#'
#' The output includes both Cox-based HRs and AHR metrics:
#' \itemize{
#'   \item hr.H.true, hr.H.hat: Cox-based HRs for harm subgroup
#'   \item hr.Hc.true, hr.Hc.hat: Cox-based HRs for complement
#'   \item ahr.H.true, ahr.H.hat: Average HRs for harm subgroup
#'   \item ahr.Hc.true, ahr.Hc.hat: Average HRs for complement
#' }
#'
#' @examples
#' \dontrun{
...
#'
#' # Run single simulation with use_twostage = FALSE (default)
