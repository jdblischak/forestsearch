...
#   - create_summary_table(): gt-based formatted output
#
# =============================================================================
...
#'
#' Creates a formatted gt table from simulation results summary.
#'
...
#'
#' @importFrom gt gt tab_header tab_row_group tab_footnote tab_style cell_fill
#'   cells_row_groups tab_options px tab_source_note cols_label cols_width
#' @export
