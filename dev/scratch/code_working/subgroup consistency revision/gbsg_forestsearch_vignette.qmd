...
both halves consistently show hazard ratios ≥ 1.0.
...
|-----------|-------|-------------|
| `hr.threshold` | 1.0 | Minimum HR for consistency evaluation |
| `hr.consistency` | 0.9 | Minimum consistency rate for candidates |
