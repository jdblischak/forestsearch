...
system.time({fs <- forestsearch(df.analysis,  confounders.name = confounders.name,
                                ...
                                sg_focus = "hr", max_subgroups_search = 20, use_twostage = TRUE,
                                parallel_args = list(plan="callr", workers = 30, show_message = TRUE, batch_size = 2),
