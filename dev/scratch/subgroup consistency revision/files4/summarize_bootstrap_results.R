 ...
 # ===========================================================================
  ...
  if (has_timing) {
    ...
    if (has_search_timing) {
      fs_stats <- list(
        mean = mean(results$tmins_search, na.rm = TRUE),
        median = median(results$tmins_search, na.rm = TRUE),
        sd = sd(results$tmins_search, na.rm = TRUE),
        min = min(results$tmins_search, na.rm = TRUE),
        max = max(results$tmins_search, na.rm = TRUE)
      )
    }
    ...
    if (has_iteration_timing && has_search_timing) {
      ...
      overhead_stats <- list(
        mean = mean(overhead, na.rm = TRUE),
        median = median(overhead, na.rm = TRUE),
        pct_of_total = 100 * mean(overhead, na.rm = TRUE) /
