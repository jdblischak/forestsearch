...
: ForestSearch subgroup selection criteria. {#tbl-sgfocus}
...
: Type-1 error and approximate 80% power thresholds. {#tbl-power}
...
: Variable selection recommendations. {#tbl-varsel}
...
: Computational timing for ForestSearch. Parallel computing is implemented via the `doFuture` package. {#tbl-timing}
