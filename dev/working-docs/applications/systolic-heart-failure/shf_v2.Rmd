...
#file_out_here <- c("applications/systolic-heart-failure/output/shf_v0.Rdata")
file_out_here <- NULL
...
setup_files <- function(dirpath1=c("/media/larryleon/My Projects/"),dirpath2=c("/Users/larryleon/Documents/"),
                        ...
                        resdir=c("GitHub/Forest-Search/paper/SBR/"),
                        file_out =NULL){
...
maxdepth=2, n.min = 60, dmin.grf = 4, frac.tau=0.6, details=TRUE)
...
hr.consistency<-1/.80  # Candidates for many splits
...
cut_type="default",
dmin.grf=4, frac.tau=0.60, grf_depth=2,
maxk=2,
sg_focus="Nsg_only",
n.min=60,
fs.splits=1000,
...
```{r FStenfold, echo=TRUE, eval=FALSE}
...
fs_ten <- forestsearch_tenfold(fs.est=fs.est,Kfolds=5,sims=tenfoldsims,details=TRUE)
