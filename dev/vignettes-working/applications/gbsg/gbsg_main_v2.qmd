...
fs_ten <- forestsearch_tenfold(fs.est = fs, sims = 50, Kfolds = 10, details=TRUE, parallel_args = list(plan = "callr", workers = 36, 
        show_message = TRUE))
...
# Create the forest plot
 result <- plot_subgroup_results_forestplot(
   fs_results = list(fs.est = fs, fs_bc = fs_bc, fs_kfold = fs_ten, cv_source="oob"),
