...
Exploratory subgroup analyses for the *ESCC* population based on overall survival outcomes will be conducted.
...
Note that these estimates are not adjusted for SGs
