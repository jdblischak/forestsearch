...
# package/
# ├── data/           # Processed .rda files (what users access)
# ├── data-raw/       # Raw data and processing scripts
# ├── R/              # Package functions
# ├── man/            # Documentation
# └── inst/extdata/   # External data files (CSV, etc.)

  
# In data-raw/prepare_data.R
library(usethis)

# Load and prepare your data
gbsg <- read.csv("data-raw/gbsg_raw.csv")
# ... data cleaning steps ...
...
usethis::use_data(gbsg, another_dataset, overwrite = TRUE)  
